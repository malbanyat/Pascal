...
WELCOME = "Hi! I am Pascal and I can learn how to speak! You can interact with me using the following commands:" + \
          ...
          "\n- /fioridex : If I say something funny, you can make a screenshot and send it with this command in the description. Your screenshot could get published on @bestofpascal. In case of an audio message, just reply to it with /fioridex" + \
...
def main():
    ...
    dp.add_handler(CommandHandler("fioridex", fioridex))
    dp.add_handler(CommandHandler("bestofpascal", fioridex))
    ...
    dp.add_handler(MessageHandler(Filters.photo, fioridex))
